...
In MacOS, there's a "Background Sounds" section in the
`System Settings > Accessibility > Audio` section that allows one of several
background sounds to be chosen.
